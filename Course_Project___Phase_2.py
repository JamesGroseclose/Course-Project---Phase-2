...
def PrintTotals(EmpTotals):    
    ...
    print(f'Total Hours Worked: {EmpTotals["TotHour"]:,.2f}')
    print(f'Total Gross Pay: {EmpTotals["TotGrPay"]:,.2f}')
    print(f'Total Income Tax:  {EmpTotals["TotTx"]:,.2f}')
    print(f'Total Net Pay: {EmpTotals["TotNPay"]:,.2f}')
